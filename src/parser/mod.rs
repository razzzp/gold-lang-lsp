...
fn parse_comment<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], _context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>> {
...
fn parse_annotations<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], _context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>> {
...
fn parse_class<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>> {
   // annotations
...
fn parse_parent_class<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], _context : &mut C) -> Result<(&'a [Token],  (Token,Token)), ParseError<'a>> {
...
fn parse_module<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>> {
   // annotations
   let (next, _) = opt_parse_w_context(parse_annotations)(input, context)?;
   // module 
...
fn parse_constant_declaration<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], _context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>> {
   // const keyword
...
fn parse_uses<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], _context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>> {
   // uses
...
fn parse_type_declaration<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // annotations
   let (next, _) = opt_parse_w_context(parse_annotations)(input, context)?;
...
fn parse_type<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   //
   let parsers = [
      parse_type_sized,
      parse_type_composed,
...
fn parse_type_basic<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], _context : &mut C)
...
fn parse_enum_variant<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // annotations
   let (next, _) = opt_parse_w_context(parse_annotations)(input, context)?;
...
fn parse_type_sized<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], _context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // int(3), cstring(4)
...
fn parse_type_enum<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // opening (
...
fn parse_type_composed<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
...
fn parse_type_reference<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // refto/listof
...
fn parse_type_reference_options<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], _context : &mut C) -> Result<(&'a [Token],  Vec<Token>), ParseError<'a>>{
   // opening [
...
fn parse_type_range<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // e.g.: 
   //    1 to 10
   //    'a' to 'b'   
...
fn parse_type_set<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
...
fn parse_type_record_field<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // annotations
   let (next, _) = opt_parse_w_context(parse_annotations)(input, context)?;
   // ident
...
fn parse_type_record<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
...
fn parse_type_pointer<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
...
fn parse_type_array_index<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // [
...
fn parse_type_array<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // array/sequence
...
fn parse_type_procedure<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // parse proc [ident]
...
fn parse_type_function<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // parse proc [ident]
...
fn parse_type_instanceof<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
...
fn parse_global_variable_declaration<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // annotations
   let (next, _) = opt_parse_w_context(parse_annotations)(input, context)?;
   // memory?
...
fn parse_method_name_uievent<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
...
fn parse_method_name<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
...
fn parse_procedure_declaration<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // parse proc [ident]
...
fn parse_function_declaration<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
   // parse func [ident]
...
fn parse_parameter_declaration_list<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Option<Arc<dyn IAstNode>>), ParseError<'a>>{
   // opening (
   let (next, obracket_token) = match exp_token(TokenType::OBracket)(input){
      Ok((r,t)) => (r, t),
...
fn parse_parameter_declaration<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Arc<dyn IAstNode>), ParseError<'a>>{
...
fn parse_member_modifier_tokens<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], _context : &mut C) -> Result<(&'a [Token],  Token), ParseError<'a>>{
   return alt_parse([
...
fn parse_member_modifiers<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Option<Arc<AstMemberModifiers>>), ParseError<'a>>{
...
fn parse_method_external<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], _context : &mut C) -> Result<(&'a [Token],  Token), ParseError<'a>>{
   match seq_parse(&[
...
fn parse_method_forward<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], _context : &mut C) -> Result<(&'a [Token],  Token), ParseError<'a>>{
   return exp_token(TokenType::Forward)(input);
}

/// parsers all modifiers, whether it is valid will be done in semantic analysis
fn parse_method_modifiers<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Option<AstMethodModifiers>), ParseError<'a>>{
...
#[allow(unused)]
/// parsers all modifiers, whether it is valid will be done in sematic analysis
fn parse_method_modifiers_<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token],  Option<AstMethodModifiers>), ParseError<'a>>{
   // private
...
fn parse_method_body<'a, C: IParserContext<'a> + 'a>(input : &'a [Token], context : &mut C) -> Result<(&'a [Token], Option<AstMethodBody>), ParseError<'a>>{
